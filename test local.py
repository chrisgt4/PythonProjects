...
ofile = open('Local_Svr_Group_Members.csv','wb')
        ...
        while True:
            ...
            for member in memberdata:
                ...
                try:
                    ...
                    if adtime == 1316963028 or adtime == 0 or adtime == 9223372036854775807:
                        lastlogon = "Never"
                    else:
                        lastlogon = conv_AD_time(adtime)
                    wlist.append(lastlogon)
                    if info['acct_expires'] == 9223372036854775807 or info['acct_expires'] == 0 or info['acct_expires'] == 4294967295:
                        acctExp = None
