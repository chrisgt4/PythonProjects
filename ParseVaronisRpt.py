...
with open(flNm,"r") as readFl:
    ...
    for data in reader:
        ...
        sql = "INSERT INTO dbo.F_Drive_Permissions (File_Server, Access_Path, Is_Root_Folder, Is_F_Drive_Folder, User_Group_Fully_Qual_Name, User_Group_Clean_Name, Full_Control, Modify, Read_File, "
